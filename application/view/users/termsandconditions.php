    ...
    <center>
        ...
        <ol type="a">
            <li>
                ...
                (information or software) on SFSUSWE's web site for personal, 
                ...
                <ol type="i">
                    ...
                    <li>attempt to decompile or reverse engineer any software contained on SFSUSWE's web site;</li>
            ...
            <li>
                ...
                SFSUSWE at any time. Upon terminating your viewing of these materials or upon the termination of this license, 
        ...
        <ol type="a">
            <li>
                The materials on SFSUSWE's web site are provided "as is". SFSUSWE makes no warranties, expressed or implied, 
                ...
                or other violation of rights. Further, SFSUSWE does not warrant or make any representations concerning the 
        ...
        <p>
            In no event shall SFSUSWE or its suppliers be liable for any damages (including, without limitation, damages for 
            loss of data or profit, or due to business interruption,) arising out of the use or inability to use the materials 
            on SFSUSWE's Internet site, even if SFSUSWE or a SFSUSWE authorized representative has been notified orally or in 
        ...
        <p>
            The materials appearing on SFSUSWE's web site could include technical, typographical, or photographic errors. 
            SFSUSWE does not warrant that any of the materials on its web site are accurate, complete, or current. SFSUSWE 
            may make changes to the materials contained on its web site at any time without notice. SFSUSWE does not, 
        ...
        <p>
            SFSUSWE has not reviewed all of the sites linked to its Internet web site and is not responsible for the 
            contents of any such linked site. The inclusion of any link does not imply endorsement by SFSUSWE of the site. 
        ...
        <p>
            SFSUSWE may revise these terms of use for its web site at any time without notice. By using this web site 
        ...
        <p>
            Any claim relating to SFSUSWE's web site shall be governed by the laws of the State of California without 
        ...
        <p>
            Your privacy is very important to us. Accordingly, we have developed this Policy in order for you to understand how we 
