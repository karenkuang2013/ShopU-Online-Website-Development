...
<div class="container-fluid">
        ...
        <div class="col-md-6">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="col-md-12"><label for="email_address">Email Address:</label></div>
                        <div class="col-md-12"><input type="text" id="email_address" name="email_address" class="form-control" /></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class ="container">
        ...
        <div class="col-md-6">
            ...
            <span class="monospaced">
                <a href="<?php echo URL . 'items/orderSuccess/' . htmlspecialchars($item->id, ENT_QUOTES, 'UTF-8'); ?>">
                    <button id="submit" class="btn btn-lg btn-warning btn-full-width pull-right">
                        Submit
                    </button>
                </a>
            </span>
